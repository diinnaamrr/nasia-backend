...
public function store(Request $request)
{
    $validator = Validator::make($request->all(), [
        ...
        'identity_type' => 'nullable|in:passport,driving_license,nid',
        ...
        'vehicleLetter' => 'required|string|max:10',
        'vehicleNumber' => 'required|string|max:20',
        'vehicleColor' => 'required|string|max:50',

        'earning' => 'nullable|string|max:50'
    ], [
        'f_name.required' => translate('messages.first_name_is_required'),
        'vehicle_id.required' => translate('messages.select_a_vehicle'),
        'vehicleLetter.required' => translate('messages.vehicle_letter_is_required'),
        'vehicleNumber.required' => translate('messages.vehicle_number_is_required'),
        'vehicleColor.required' => translate('messages.vehicle_color_is_required'),
    ...
    $dm->l_name = $request->l_name ?? null;
    $dm->email = $request->email;
    $dm->phone = $request->phone;
    $dm->identity_number = $request->identity_number ?? null;
    $dm->identity_type = $request->identity_type ?? null;
    $dm->identity_image = $identity_image;
    $dm->vehicle_id = $request->vehicle_id;
    $dm->vehicle_letter = $request->vehicleLetter;
    $dm->vehicle_number = $request->vehicleNumber;
    $dm->vehicle_color = $request->vehicleColor;
    $dm->image = $image_name;
    $dm->status = 0;
    $dm->active = 0;
    $dm->application_status = 'pending';
    $dm->zone_id = $request->zone_id ?? null;
    $dm->earning = $request->earning ?? null;
