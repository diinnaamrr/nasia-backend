...
Route::get('get-all-products/{id}', 'HomeController@getAllProducts')->name('get-all-products');
...
Route::group(['prefix' => 'landingdashboard', 'as' => 'landingdashboard.'], function () {
    Route::get('/', [\App\Http\Controllers\LandingDashboard\HomeController::class, 'index'])->name('home');
    Route::get('flash-sales-items/search', [\App\Http\Controllers\LandingDashboard\PromoCampaignController::class, 'getItems'])->name('flash-sales.items.search');
    Route::resource('departments', \App\Http\Controllers\LandingDashboard\DepartmentController::class);
    Route::resource('stock-units', \App\Http\Controllers\LandingDashboard\StockUnitController::class);
    Route::resource('flash-sales', \App\Http\Controllers\LandingDashboard\PromoCampaignController::class);
});
