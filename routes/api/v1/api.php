...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'Auth'], function () {
        ...
        Route::post('verify-phone', 'CustomerAuthController@verify_phone_or_email')->withoutMiddleware(['auth:api']);
        ...
        Route::post('dev-reset-password', 'CustomerAuthController@dev_reset_password');
        Route::post('dev-check-user', 'CustomerAuthController@dev_check_user');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware'=>['dm.api']], function () {
            ...
            Route::get('statistics-summary', 'DeliverymanController@get_statistics_summary');
            Route::get('weekly-report', 'DeliverymanController@get_weekly_report');
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::group(['prefix' => 'trader'], function () {
                Route::get('status', 'StoreRegistrationController@checkTraderStatus');
                Route::get('has-documents', 'StoreRegistrationController@hasUploadedDocuments');
                Route::post('register', 'StoreRegistrationController@registerAsTrader');
                ...
                Route::get('items', 'TraderController@getItems');
                Route::put('item/stock', 'TraderController@updateStock');
            });
...
Route::get('/test-sms', function () {
    $service = app(WhySMSService::class); // بيستدعي الخدمة من الـ Service Container
    $response = $service->sendSMS('201128828067', 'رسالة اختبار من السيرفر'); 
    return $response; // بيرجع الريسبونس (غالبًا JSON أو سترينج)
});
