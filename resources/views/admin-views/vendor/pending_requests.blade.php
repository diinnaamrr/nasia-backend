                ...
                <div class="col-md-12">
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
                        ...
                        <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
                             <li class="nav-item">
                                <a class="nav-link {{ $tab == 'store' ? 'active' : '' }}" href="{{ route('admin.store.pending-requests', ['tab' => 'store']) }}"   aria-disabled="true">{{translate('messages.pending_stores')}}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ $tab == 'trader' ? 'active' : '' }}" href="{{ route('admin.store.pending-requests', ['tab' => 'trader']) }}"   aria-disabled="true">{{translate('messages.pending_traders')}}</a>
                            </li>
                            <li class="nav-item">
                ...
                <table id="columnSearchDatatable"
                    ...
                    <thead class="thead-light">
                     <tr>
                        ...
                        @if($tab == 'trader')
                            <th class="border-0">{{translate('messages.trader_information')}}</th>
                            <th class="border-0">{{translate('messages.documents')}}</th>
                            <th class="border-0">{{translate('messages.registration_date')}}</th>
                        @else
                    ...
                    <tbody id="set-rows">
                     @foreach($stores as $key=>$store)
                        <tr>
                            ...
                            @if($tab == 'trader')
                                <td>
                                    <div>
                                        <div class="table-rest-info">
                                            ...
                                            src="{{ $store['trader_image_full_url'] ?? asset('public/assets/admin/img/160x160/img1.jpg') }}" >
                                            <div class="info">
                                                <div class="text--title">
                                                    {{$store->f_name}} {{$store->l_name}}
                                                </div>
                                ...
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        <a href="{{$store->card_face_full_url}}" target="_blank" class="badge badge-soft-info">
                                            {{translate('ID_Front')}}
                                        </a>
                                        <a href="{{$store->card_back_full_url}}" target="_blank" class="badge badge-soft-info">
                                            {{translate('ID_Back')}}
                                        </a>
                                    </div>
                                </td>
                            ...
                            <td>
                                @if($tab == 'trader')
                                    <span class="badge badge-soft-warning">{{translate('messages.pending_approval')}}</span>
                                @else
                            ...
                            <td>
                                <div class="btn--container">
                                    @if($tab == 'trader')
                                        ...
                                        data-url="{{route('admin.store.trader-approval',[$store['id'],1])}}" data-message="{{translate('messages.you_want_to_approve_this_trader')}}"
                                        ...
                                        data-url="{{route('admin.store.trader-approval',[$store['id'],0])}}" data-message="{{translate('messages.you_want_to_deny_this_trader_request')}}"
