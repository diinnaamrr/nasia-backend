                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    @php($min_order_qty_for_trader = \App\Models\BusinessSetting::where('key', 'min_order_qty_for_trader')->first())
                                    <div class="form-group mb-0">
                                        <label class="form-label text-capitalize"
                                            for="min_order_qty_for_trader">
                                            {{ translate('messages.min_order_qty_to_become_trader') }}
                                            <span class="form-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('messages.If_a_customer_orders_more_than_this_quantity,_they_will_be_prompted_to_become_a_trader.') }}">
                                                <img src="{{asset('public/assets/admin/img/info-circle.svg')}}" alt="">
                                            </span>
                                        </label>
                                        <input type="number" name="min_order_qty_for_trader" class="form-control"
                                            id="min_order_qty_for_trader" min="1"  placeholder="{{ translate('messages.Ex:_120') }}"
                                            value="{{ $min_order_qty_for_trader ? $min_order_qty_for_trader->value : 120 }}"
                                            required>
                                    </div>
                                </div>
