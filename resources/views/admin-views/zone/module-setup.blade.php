...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row gy-1 fw-bold" id="mod-label">
            <div class="col-sm-2"><label>{{ translate('messages.Module Name') }}</label></div>
            <div class="col-sm-1"><label>{{ translate('messages.per_km_delivery_charge') }} ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
            <div class="col-sm-1"><label>{{ translate('messages.Minimum delivery charge') }} ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
            <div class="col-sm-1"><label>{{ translate('messages.Maximum delivery charge') }} ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
            <div class="col-sm-1"><label>{{ translate('maximum_cod_order_amount') }} ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
            <div class="col-sm-1"><label>المسافة الثابتة (كم)</label></div>
            <div class="col-sm-1"><label>السعر الثابت ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
            <div class="col-sm-1"><label>سعر كل كم إضافي ({{ \App\CentralLogics\Helpers::currency_symbol() }})</label></div>
        </div>
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" value="{{ $module->module_name }}" readonly>
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][per_km_shipping_charge]"
                        value="{{ $module->pivot->per_km_shipping_charge }}"
                        {{ $module->module_type == 'parcel' ? 'readonly placeholder='.translate('Set charge from parcel category') : 'required' }}>
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][minimum_shipping_charge]"
                        value="{{ $module->pivot->minimum_shipping_charge }}"
                        {{ $module->module_type == 'parcel' ? 'readonly placeholder='.translate('Set charge from parcel category') : 'required' }}>
                </div>
                ...
                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        ...
                        value="{{ $module->pivot->maximum_shipping_charge }}">
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][maximum_cod_order_amount]"
                        value="{{ $module->pivot->maximum_cod_order_amount }}">
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][base_distance_km]"
                        value="{{ $module->pivot->base_distance_km }}">
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][base_fee]"
                        value="{{ $module->pivot->base_fee }}">
                </div>

                <div class="col-sm-1">
                    <input type="number" step=".01" min="0" class="form-control"
                        name="module_data[{{ $module->id }}][extra_price_per_km]"
                        value="{{ $module->pivot->extra_price_per_km }}">
                </div>
            </div>
                            @else
                          <div class="row gy-1 module-row" id="module_{{ $module->id }}">
