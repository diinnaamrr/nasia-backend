...
<div class="form-group">
    <label class="input-label" for="sku">{{ translate('messages.بار كود') }}</label>
    <input type="text" name="sku" class="form-control" id="sku" value="{{ old('sku', $product->sku) }}" placeholder="{{ translate('Enter SKU') }}" required>
</div>
                              
                              <div class="col-sm-{{ Config::get('module.current_module_type') == 'food' ? '4' :'3' }} col-6">
    <div class="form-group mb-0">
    <label class="input-label" for="cost">{{ translate('messages.التكلفة') }} 
    ...
    <input type="number" min="0" max="999999999999.99" step="0.01"
           value="{{ old('cost', $product->cost ?? '') }}" name="cost" class="form-control"
           placeholder="{{ translate('messages.Ex:') }} 50" required>
</div>
                                ...
                                @endif
                                 ...
                                 <div class="col-sm-6 col-lg-3">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="production_date">
                                            {{ translate('production_date') }}
                                        </label>
                                        <input type="date" class="form-control" name="production_date" id="production_date" 
                                            value="{{ isset($temp_product) && $temp_product == 1 ? ($product->production_date ?? '') : ($product->production_date ? \Carbon\Carbon::parse($product->production_date)->format('Y-m-d') : '') }}">
                                    </div>
                                </div>

                                <div class="col-sm-6 col-lg-3">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="expiration_date">
                                            {{ translate('expiration_date') }}
                                        </label>
                                        <input type="date" class="form-control" name="expiration_date" id="expiration_date" 
                                            value="{{ isset($temp_product) && $temp_product == 1 ? ($product->expiration_date ?? '') : ($product->expiration_date ? \Carbon\Carbon::parse($product->expiration_date)->format('Y-m-d') : '') }}">
                                    </div>
                                </div>
