...
<head>
    ...
    <meta property="og:image" content="{{ asset('public/assets/landing/img/Nasia.jpeg') }}">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:image" content="{{ asset('public/assets/landing/img/Nasia.jpeg') }}">
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('public/assets/landing/img/Nasia.jpeg') }}">
    @stack('css_or_js')
    ...
    <style>
        :root {
            ...
            --header-bg: #fdfbf7 !important;
        }

        /* Essential Global Overrides */
        .cmn--btn, .btn--base, .bg--base, .bg-base {
            background-color: var(--base-1) !important;
            border-color: var(--base-1) !important;
        }
        .text--base, .text-base, .active > span {
        ...
        .logo, .footer-logo, .logo img, .footer-logo img {
            border-radius: 8px;
            overflow: hidden;
                ...
                <div class="navbar-bottom-wrapper">
                    ...
                    <a href="{{ route('home') }}" class="logo">
                        <img class="onerror-image"
                            ...
                            src="{{ asset('public/assets/landing/img/Nasia.jpeg') }}"
                            alt="image">
                    </a>
                    <ul class="menu">
                        <li>
            ...
            <div class="container">
                <div class="newsletter-wrapper">
                    <div class="newsletter-content position-relative">
                        <h3 class="title">{{ __('messages.Sign Up to Our Newsletter') }}</h3>
                        <div class="text">
                            {{ __('messages.Receive Latest News, Updates and Many Other News Every Week') }}
                        </div>
                        <form method="post" action="{{route('newsletter.subscribe')}}">
                            @csrf
                            <div class="input--grp">
                                <input type="email" name="email" required class="form-control" placeholder="{{ __('messages.Enter your email address') }}">
                ...
                <div class="footer-wrapper ps-xl-5">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a class="logo">
                                <img  class="onerror-image"  data-onerror-image="{{ asset('public/assets/landing/img/Nasia.jpeg') }}" src="{{ asset('public/assets/landing/img/Nasia.jpeg') }}" alt="image">
                            </a>
                        </div>
                        <div class="txt">
                            {{ __('messages.NASIA Marketplace') }} 
                        </div> 
