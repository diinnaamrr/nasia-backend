...
',
  ...
  'order_already_canceled' => 'This order is canceled. You cannot accept or update it.',
...
Smartly or Earn. ',
  ...
  'base_url' => 'Base url',
  'smsmisr' => 'Smsmisr',
  'Extra charge per km' => 'Extra charge per km',
  ...
  'trader_documents_required' => 'Trader documents required',
  'trader_registration_pending_approval' => 'Trader registration pending approval',
  'Jameson Hobbs' => 'Jameson Hobbs',
  'trader_already_approved' => 'Trader already approved',
  ...
  'you_can_fulfill_order_nearby' => 'You can fulfill order nearby',
  ...
  'Elite Departments' => 'Elite Departments',
  'Fresh Harvest' => 'Fresh Harvest',
  'Daily handpicked organic fruits and vegetables from elite local farms.' => 'Daily handpicked organic fruits and vegetables from elite local farms.',
  'Explore Now' => 'Explore Now',
  'Artisan Bakery' => 'Artisan Bakery',
  'Traditional recipes and premium ingredients bake our signature pastries and breads.' => 'Traditional recipes and premium ingredients bake our signature pastries and breads.',
  'Prime Cuts' => 'Prime Cuts',
  'Highest grade poultry and meats, expertly prepared for the most discerning palates.' => 'Highest grade poultry and meats, expertly prepared for the most discerning palates.',
  'Gourmet Deli' => 'Gourmet Deli',
  'International selection of fine cheeses, charcuterie, and specialty delicacies.' => 'International selection of fine cheeses, charcuterie, and specialty delicacies.',
  'Quality' => 'Quality',
  'Explore our curated selection of ' => 'Explore our curated selection of ',
  'Elite' => 'Elite',
  ...
  'NASIA Marketplace' => 'NASIA Marketplace',
  'Sign Up to Our Newsletter' => 'Sign Up to Our Newsletter',
  'Receive Latest News, Updates and Many Other News Every Week' => 'Receive Latest News, Updates and Many Other News Every Week',
  ...
  'Create Stock Unit' => 'Create Stock Unit',
  'Edit Stock Unit' => 'Edit Stock Unit',
  'Create Flash Sale' => 'Create Flash Sale',
  'Edit Flash Sale' => 'Edit Flash Sale',
  'Genesis Admin' => 'Genesis Admin',
  'SUPREME ACCESS' => 'SUPREME ACCESS',
  'OPERATIONAL CORE' => 'OPERATIONAL CORE',
  'Precision management for your digital distribution engine. Monitor and scale your flash operations across all endpoints.' => 'Precision management for your digital distribution engine. Monitor and scale your flash operations across all endpoints.',
  'Initiate Deployment' => 'Initiate Deployment',
  'ENERGISED' => 'ENERGISED',
  'SEQUENCING' => 'SEQUENCING',
  'TERMINATED' => 'TERMINATED',
  'Awaiting Commands' => 'Awaiting Commands',
  'Your distribution pipeline is currently clear.' => 'Your distribution pipeline is currently clear.',
  'Deployments' => 'Deployments',
  'TOTAL' => 'TOTAL',
  'Add Stock Unit' => 'Add Stock Unit',
  'Base Price' => 'Base Price',
  'Quantity' => 'Quantity',
  'Thumbnail' => 'Thumbnail',
  'Operational' => 'Operational',
  'Stock Inventory' => 'Stock Inventory',
  'Monitor and manage the specific units available for distribution.' => 'Monitor and manage the specific units available for distribution.',
  'Product Module' => 'Product Module',
  'Domain' => 'Domain',
  'Price / Stock' => 'Price / Stock',
  'Actions' => 'Actions',
  'Core Departments' => 'Core Departments',
  'Manage the primary building blocks of your distribution network.' => 'Manage the primary building blocks of your distribution network.',
  'New Department' => 'New Department',
  'Identity' => 'Identity',
  'Visible' => 'Visible',
  'Hidden' => 'Hidden',
  'DEACTIVATED' => 'DEACTIVATED',
  'Abort deployment?' => 'Abort deployment?',
  'Distribution Sessions' => 'Distribution Sessions',
  'Configure and monitor high-frequency promotional events.' => 'Configure and monitor high-frequency promotional events.',
  ...
  'Discount (%)' => 'Discount (%)',
  'Select Units & Set Discounts' => 'Select Units & Set Discounts',
  'Abort' => 'Abort',
  'Visibility Status' => 'Visibility Status',
  'Publicly Visible' => 'Publicly Visible',
  'Hidden from Users' => 'Hidden from Users',
  'Display Priority' => 'Display Priority',
  'Launch Distribution' => 'Launch Distribution',
  'Modify your existing campaign settings and products.' => 'Modify your existing campaign settings and products.',
  'Start Date & Time' => 'Start Date & Time',
  'End Date & Time' => 'End Date & Time',
  'Enabled (Published)' => 'Enabled (Published)',
  'Disabled (Draft)' => 'Disabled (Draft)',
  'Add Stock Units' => 'Add Stock Units',
  'Display Order' => 'Display Order',
  'Create' => 'Create',
  'Adjust the parameters of your core distribution categories.' => 'Adjust the parameters of your core distribution categories.',
  'Department Title' => 'Department Title',
  'Visual Manifest (Cover Image)' => 'Visual Manifest (Cover Image)',
  'Add Department' => 'Add Department',
  'Update Department' => 'Update Department',
  'Department' => 'Department',
  'Set up a new premium discount campaign for your landing page.' => 'Set up a new premium discount campaign for your landing page.',
  'End Sequence' => 'End Sequence',
  'Availability State' => 'Availability State',
  'Operational (Live)' => 'Operational (Live)',
  'Standby (Draft)' => 'Standby (Draft)',
  'Terminated (Archived)' => 'Terminated (Archived)',
  'Distribution Manifest' => 'Distribution Manifest',
  'Inject Stock Units' => 'Inject Stock Units',
  'e.g. Supernova Seasonal Event' => 'e.g. Supernova Seasonal Event',
  'Shop, sell, and deliver your products with ease.' => 'Shop, sell, and deliver your products with ease.',
  'Nasia – The integrated e-commerce platform for individuals and sellers' => 'Nasia – The integrated e-commerce platform for individuals and sellers',
  'Download App' => 'Download App',
  'Quick shopping' => 'Quick shopping',
  'Your favorite products are here' => 'Your favorite products are here',
  'Be a seller' => 'Be a seller',
  'Showcase your products immediately' => 'Showcase your products immediately',
  'For delivery' => 'For delivery',
  'Safe delivery' => 'Safe delivery',
  'Why Choose NASIA APP' => 'Why Choose NASIA APP',
  'Multi-Vendor Support' => 'Multi-Vendor Support',
  'منصة واحدة… وفرص بيع بلا حدود.' => 'One platform for unlimited vendors, each managing their store freely.',
  'لوحة تحكم البائع' => 'Vendor Dashboard',
  'إدارة متجرك بالكامل من داخل التطبيق.' => 'Vendor Dashboard integrated via Web View, manage products and orders easily.',
  'تحكم كامل في البيع' => 'Full Control & Privacy',
  'حدد السعر والكمية بحرية تامة — أنت المتحكم.' => 'Add products, set prices and quantities with no restrictions.',
  'إشعارات لحظية' => 'Instant Notifications',
  'كل طلب جديد يوصلك فورًا بدون تأخير.' => 'Receive instant alerts for new orders and track status step by step.',
  'عربي & English' => 'Arabic & English',
  'تجربة سلسة بلغتين تناسب الجميع.' => 'A smooth experience in two languages for everyone.',
  'Empowering Vendors' => 'Empowering Vendors',
  'Become a seller easily, no paperwork or complications.' => 'Become a seller easily, no paperwork or complications.',
  'Direct Product Upload' => 'Direct Product Upload',
  'Flexible Pricing & Stock' => 'Flexible Pricing & Stock',
  'Access to Global Audience' => 'Access to Global Audience',
  'Start Selling Now' => 'Start Selling Now',
  'Elite Shopping Experience' => 'Elite Shopping Experience',
  'Effortless Search & Buy' => 'Effortless Search & Buy',
  'Real-time Order Tracking' => 'Real-time Order Tracking',
  'Versatile Payment Options' => 'Versatile Payment Options',
  'Fast & Secure Delivery' => 'Fast & Secure Delivery',
  'Smart Delivery Solutions' => 'Smart Delivery Solutions',
  'Efficiently receive orders and navigate to delivery locations with our specialized app.' => 'Efficiently receive orders and navigate to delivery locations with our specialized app.',
  'للبائعين والعارضين' => 'For Vendors & Exhibitors',
  'كن بائعاً بسهولة، بدون أوراق أو تعقيدات.' => 'Become a seller easily, with no paperwork or complications.',
  'Join Platform' => 'Join Platform',
  'An easy start with no complicated paperwork or entry barriers.' => 'An easy start with no complicated paperwork or entry barriers.',
  'رفع منتجاتك مباشرة' => 'Direct Product Upload',
  'Upload your collection instantly with full control over images and details.' => 'Add your products from home with full control over details.',
  'تحديد السعر والكمية بحرية' => 'Flexible Price & Stock Control',
  'Adjust your pricing and inventory levels anytime without any restrictions.' => 'Adjust your pricing and inventory levels anytime without any restrictions.',
  'الوصول لمجموعة واسعة من العملاء' => 'Reach Wider Audience',
  'Reach thousands of active shoppers looking for premium products every day.' => 'Reach thousands of active shoppers looking for premium products every day.',
  'ابدأ البيع الآن' => 'Start Selling Now',
  'للمشترين' => 'For Shoppers',
  'استمتع بتجربة تسوق فاخرة وسهلة مع منصة ناسيا.' => 'Enjoy a luxury and easy shopping experience with Nasia Platform.',
  'سهولة البحث والشراء' => 'Easy Search & Buy',
  'Find your luxury items effortlessly with our smart search and filtering.' => 'Find your luxury items effortlessly with our smart search and filtering.',
  'متابعة الطلبات في الوقت الحقيقي' => 'Real-time Order Tracking',
  'Know exactly where your package is from the moment of purchase to delivery.' => 'Know exactly where your package is from the moment of purchase to delivery.',
  'خيارات دفع متنوعة' => 'Versatile Payment Options',
  'Multiple secure payment gateways to provide you the most convenient checkout.' => 'Multiple secure payment gateways to provide you the most convenient checkout.',
  'توصيل سريع وآمن' => 'Fast & Secure Delivery',
  'Your premium orders are handled with care and delivered with gold-standard speed.' => 'Your premium orders are handled with care and delivered with gold-standard speed.',
  'للمندوبين' => 'For Delivery Partners',
  'استلم طلباتك وتابع مواقع التوصيل بذكاء من خلال تطبيق المندوب المتطور.' => 'Receive your orders and track delivery locations intelligently through our advanced app.',
  'Join Now' => 'Join Now',
  'قالوا عن ناسيا' => 'Testimonials',
  'آراء عملائنا' => 'Customer Reviews',
  'قصص نجاح شركائنا' => 'Success Stories',
  'مشتري' => 'Verified Buyer',
  'بائع' => 'Verified Vendor',
  'حمل التطبيق وابدأ رحلتك الآن' => 'Download App & Start Your Journey Now',
  'Be a Vendor' => 'Be a Vendor',
  'MARKET' => 'MARKET',
  'More about' => 'More about',
  'Scroll' => 'Scroll',
  'إزاي بيشتغل التطبيق؟' => 'How does the app work?',
  'تصفح واشتري' => 'Browse and buy',
  'المستخدم يختار المنتجات ويضيفها للعربة بكل سهولة' => 'The user chooses products and adds them to the cart with ease',
  'كن بائع' => 'Be a vendor',
  'بلمسة واحدة زر Be a Vendor يحولك لبائع مباشرة' => 'With one tap, the Be a Vendor button turns you into a seller directly',
  'رفع المنتجات' => 'Upload products',
  'تحكم كامل في الكمية دون أي قيود برمجية' => 'Full control over quantity without any programming restrictions',
  'توصيل سريع' => 'Fast delivery',
  'مندوب التوصيل يستلم الأوردر ويوصله للعميل فوراً' => 'The delivery partner receives the order and delivers it to the customer immediately',
  'دعم متعدد البائعين' => 'Multi-vendor support',
  'تسوق من بائعين متعددين' => 'Shop from multiple vendors',
  'اكتشف منتجات متنوعة من بائعين مختلفين في مكان واحد' => 'Discover diverse products from different vendors in one place',
  'تتبع طلباتك بسهوله' => 'Track your orders easily',
  'راقب حاله طلبك من لحظه الشراء حتي التسليم' => 'Track your order status from the moment of purchase until delivery',
  ...
  'أفضل تطبيق للتسوق في المنطقة. خيارات الدفع متنوعة ومريحة، والدعم الفني دايماً موجود للمساعدة.' => 'The best shopping app in the region. Payment options are diverse and convenient, and technical support is always available to help.',
  'الرحلة تبدأ هنا' => 'The journey begins here',
  'حدد الكمية بحرية تامة — أنت المتحكم.' => 'You are in control of the quantity.',
  ...
  'Want_to_sell_from_home_with_minimal_capital?' => 'Want to sell from home with minimal capital?',
  'Open_your_own_store_without_a_shop_or_large_inventory_we_handle_shipping_and_marketing_you_sell_and_earn!' => 'Open your own store without a shop or large inventory we handle shipping and marketing you sell and earn!',
  'Start_as_a_seller_now' => 'Start as a seller now',
  ...
  'nasia_smart_investment_and_shopping' => 'Nasia: Smart Investment and Refined Shopping',
  'your_integrated_gateway_for_financial_growth' => 'Your integrated gateway for financial growth through investment from home, and a unique shopping experience that meets your aspirations.',
  'start_now' => 'Start Now',
  'discover_more' => 'Discover More',
  'our_integrated_services_shop_smart' => 'Our Integrated Services: Shop Smart and Start Your Business',
  'nasia_integrated_platform_description' => 'Whether you are a user looking for quality and speed in shopping, an ambitious merchant seeking to build your own project, or a delivery hero seeking to increase your income and join our fleet; Nasia provides you with everything you need in one integrated platform.',
  'refined_shopping' => 'Refined Shopping',
  'refined_shopping_description' => 'Enjoy a unique shopping experience that combines quality and luxury for all your needs.',
  'smart_investment' => 'Smart Investment',
  'smart_investment_description' => 'Become a distinguished merchant in your area through smart investment and wholesale buying.',
  'fast_delivery' => 'Fast Delivery',
  'fast_delivery_description' => 'Join the Nasia fleet as a delivery captain, and start your journey to increase your income and returns.',
  'start_your_business' => 'Start Your Business',
  'join_us' => 'Join Us',
  'why_nasia_is_your_first_choice' => 'Why is Nasia your first choice?',
  'why_nasia_description' => 'We combine smart investment opportunities and integrated shopping services in one platform. Whether you are looking to build your project from home at the lowest costs or want to get everything you need with a fast and safe shopping experience, Nasia is here to meet your ambitions and make your life easier.',
  'start_your_own_business_description' => 'Start your own business and achieve sustainable returns through our advanced platform.',
  'refined_shopping_short_description' => 'Enjoy a unique shopping experience that combines high quality and absolute luxury.',
  'join_as_captain_description' => 'Be part of our distinguished team and start increasing your income through the Nasia fleet.',
  'join_as_captain' => 'Join as Captain',
  'earn_with_nasia' => 'Earn with Nasia',
  'referral_description' => 'Invite your friends and set off together on a journey of excellence. With Nasia, every invitation is a new step towards shared success and extraordinary rewards.',
  'horizons_of_success_with_nasia' => 'Horizons of success with Nasia',
  'nasia_is_your_partner_for_success' => 'Whether you sell or deliver; Nasia is your partner for success and abundance',
  'order_now' => 'Order Now',
  'discover_products_from_various_sellers' => 'Discover diverse products from different sellers in one place',
  'shop_from_multiple_sellers' => 'Shop from multiple sellers',
  'register_now' => 'Register Now',
  'start_your_success_journey' => 'Start your success journey and expand your business through the Nasia integrated platform',
  'become_a_merchant' => 'Become a Merchant',
  'join_our_fleet' => 'Join our fleet and be the quality companion in delivering orders to our customers',
  'delivery_services' => 'Delivery Services',
  'manage_your_business_smartly' => 'Manage your business smartly',
  'from_your_personal_phone' => 'From your personal phone',
  'and_start_earning_now' => 'And start earning your profits now',
  'success_stories_title' => 'Success Stories: From a simple idea to financial sovereignty',
  'testimonial_name_1' => 'Aisha Al-Hashem',
  'entrepreneur' => 'Entrepreneur',
  'testimonial_review_1' => 'I started from a simple idea at home, and with the support of the Nasia platform, my idea turned into a well-known brand and real financial sovereignty. The journey was inspiring and the results exceeded my expectations.',
  'testimonial_name_2' => 'Omar Farouk',
  'tech_investor' => 'Tech Investor',
  'testimonial_review_2' => 'Nasia enabled me to turn my passion for technology into a successful investment project, achieving stable financial independence. The platform is the ideal partner for everyone seeking real growth.',
  'testimonial_name_3' => 'Sarah Johnson',
  'product_designer' => 'Product Designer',
  'testimonial_review_3' => 'The simplicity of the beginning was not an obstacle; Nasia was the bridge I crossed from being just a hobbyist to a businesswoman managing a profitable and financially stable project.',
  'why_trading_is_harder_title' => 'Why trading is harder title',
  'why_trading_is_harder_description' => 'Why trading is harder description',
  'middlemen_problem' => 'Middlemen problem',
  'middlemen_problem_desc' => 'Middlemen problem desc',
  'source_access_problem' => 'Source access problem',
  'source_access_problem_desc' => 'Source access problem desc',
  'logistics_chaos_problem' => 'Logistics chaos problem',
  'logistics_chaos_problem_desc' => 'Logistics chaos problem desc',
  'role_as_customer' => 'Role as customer',
  'customer_title' => 'Customer title',
  'customer_benefits_list' => 'Customer benefits list',
  'start_saving_now' => 'Start saving now',
  'role_as_merchant' => 'Role as merchant',
  'merchant_title' => 'Merchant title',
  'merchant_description' => 'Merchant description',
  'increase_my_profits' => 'Increase my profits',
  'role_as_supplier' => 'Role as supplier',
  'supplier_title' => 'Supplier title',
  'supplier_description' => 'Supplier description',
  'deliver_to_everywhere' => 'Deliver to everywhere',
  'role_as_captain' => 'Role as captain',
  'captain_title' => 'Captain title',
  'captain_description' => 'Captain description',
  'join_our_fleet_now' => 'Join our fleet now',
  'merchant' => 'Merchant',
  'supplier' => 'Supplier',
  'captain' => 'Captain',
  'real_saving' => 'Real saving',
  'buy_direct_from_factory' => 'Buy direct from factory',
  'save_30_percent_desc' => 'Save 30 percent desc',
  'smart_growth' => 'Smart growth',
  'double_your_merchant_profits' => 'Double your merchant profits',
  'merchant_growth_desc' => 'Merchant growth desc',
  'register_as_merchant' => 'Register as merchant',
  'be_part_of_logistics_fleet' => 'Be part of logistics fleet',
  'captain_income_flexibility_desc' => 'Captain income flexibility desc',
  'join_the_fleet' => 'Join the fleet',
  'horizons_of_success_title' => 'Horizons of success title',
  'impact_section_description' => 'Impact section description',
  'fast_expansion' => 'Fast expansion',
  'fast_expansion_desc' => 'Fast expansion desc',
  'guaranteed_quality' => 'Guaranteed quality',
  'guaranteed_quality_desc' => 'Guaranteed quality desc',
  'continuous_support' => 'Continuous support',
  'continuous_support_desc' => 'Continuous support desc',
  'custom_customer_role' => 'Custom customer role',
  'custom_merchant_role' => 'Custom merchant role',
  'custom_captain_role' => 'Custom captain role',
  'Get the App' => 'Get the App',
  'custom_customer_role' => 'User (Customer)',
  'custom_merchant_role' => 'Merchant (Business Owner)',
  'custom_captain_role' => 'Captain (Delivery)',
  'success_stories_title' => 'Success Stories from Nasia',
  'testimonial_name_1' => 'Ahmed Mansour',
  'testimonial_review_1' => 'Nasia saved me 25% on monthly household expenses by buying groceries and products at wholesale prices. Quality is excellent and delivery is always on time.',
  'testimonial_name_2' => 'Mahmoud Issa',
  'testimonial_review_2' => 'As a retailer, I was able to connect directly with factories and suppliers, which significantly increased my profits. Inventory control and order tracking became much easier.',
  'testimonial_name_3' => 'Yahya Gamal',
  'testimonial_review_3' => 'The platform is very easy to use, income is daily, and trips are intelligently organized, allowing me to make more trips in less time and without wasted effort on the road.',
  'cat_home_kitchen' => 'Home & Kitchen',
  'cat_home_kitchen_desc' => 'Everything you need for a modern and comfortable home at the best prices.',
  'cat_electronics' => 'Electronics & Mobiles',
  'cat_electronics_desc' => 'The latest electronic devices and mobiles with Nasia warranty.',
  'cat_fashion' => 'Fashion',
  'cat_fashion_desc' => 'A world of elegance suitable for all family members.',
  'cat_supermarket' => 'Supermarket',
  'cat_supermarket_desc' => 'Your daily needs delivered to your doorstep with ease.',
  'cat_medical' => 'Medical Supplies',
  'cat_medical_desc' => 'Integrated healthcare for your safety and your family`s safety.',
  'why_trading_is_harder_title' => 'Why has trade and selling become harder?',
  'why_trading_is_harder_description' => 'Every day we face challenges that hinder business growth and increase costs for everyone. At Nasia, we analyzed these problems to build a better future.',
  'middlemen_problem' => 'Multiple Middlemen',
  'middlemen_problem_desc' => 'Profit is lost between many intermediaries, making the price reach high for both the merchant and the end customer.',
  'source_access_problem' => 'Difficulty Reaching Sources',
  'source_access_problem_desc' => 'Merchants struggle to reach factories and suppliers directly, which reduces competitiveness.',
  'logistics_chaos_problem' => 'Logistics Chaos',
  'logistics_chaos_problem_desc' => 'Shipping and delivery issues and inaccurate timing cause great losses and disrupt the commercial cycle.',
  'Get the App' => 'Download the App Now',
  'role_as_customer' => 'As a Customer (Shopper)',
  'customer_title' => 'Buy at Source Price and Save Expenses',
  'customer_benefits_list' => '<ul class="benefits-list"><li>Save up to 30% of your home budget by buying at wholesale prices directly</li><li>Forget the fatigue of markets, order all your needs with one click to your door</li><li>Huge variety of products from thousands of certified suppliers</li><li>Smart tracking system ensures your order arrives on time</li></ul>',
  'role_as_merchant' => 'As an Independent Merchant',
  'merchant_title' => 'Start Your Own Business: Buy Wholesale & Become the Merchant',
  'merchant_description' => 'No large capital or physical store needed. Nasia empowers you to buy in bulk at source prices to start your independent trading path and achieve exceptional profits.',
  'role_as_supplier' => 'As a Supplier / Factory',
  'supplier_title' => 'Your products in every street without distribution hassle',
  'supplier_description' => 'Open thousands of new sales outlets in an instant. Nasia provides you with a full logistics system to reach all merchants.',
  'role_as_captain' => 'As a Delivery Captain',
  'captain_title' => 'Daily Income in Your Hand.. You Are Your Own Boss',
  'captain_description' => 'Invest your bike and achieve a rewarding daily income with Nasia. Flexible schedule, organized trips, and step-by-step support.',
  'increase_my_profits' => 'Increase My Profits Now',
  'deliver_to_everywhere' => 'Deliver to Everywhere',
  'join_our_fleet_now' => 'Join Our Fleet Now',
  'real_saving' => 'Real Saving',
  'buy_direct_from_factory' => 'Buy from Factory Directly to Your Home',
  'save_30_percent_desc' => 'Save up to 30% of your budget by purchasing all your needs at the real wholesale price.',
  'start_saving_now' => 'Start Saving Now',
  'smart_growth' => 'Smart Investment',
  'double_your_merchant_profits' => 'Become a Merchant with One Click & Start Your Success',
  'merchant_growth_desc' => 'Buy the quantities that suit you at direct factory prices and start your private investment journey. We support you with competitive pricing and smart metrics to grow.',
  'register_as_merchant' => 'Register as Merchant',
  'be_part_of_logistics_fleet' => 'Be Part of the Strongest Logistics Fleet in Your Area',
  'captain_income_flexibility_desc' => 'Earn your own income with flexible hours. Nasia for easy delivery with technical intelligence and full safety.',
  'join_the_fleet' => 'Join the Fleet Now',
  'horizons_of_success_title' => 'Horizons of Success with Nasia',
  'impact_section_description' => 'We don`t just build a platform; we create a fertile environment for sustainable growth and commercial fairness for all.',
  'fast_expansion' => 'Fast Expansion',
  'fast_expansion_desc' => 'A smart system that reduces the sales cycle and allows you to expand into new markets in record time.',
  'guaranteed_quality' => 'Guaranteed Quality',
  'guaranteed_quality_desc' => 'Dealing directly with sources ensures original quality and bypasses traditional middlemen issues.',
  'continuous_support' => 'Continuous Support',
  'continuous_support_desc' => 'Our team is with you every step of the way, from technical training to field logistics support.',
  'hero_headline' => '<span class="gold-gradient">Nasia — A Platform Connecting Factories Directly</span> <br> <span class="nasia-green">to Merchants and Customers with Smart Delivery</span>',
  'hero_subheadline' => 'A smart distribution system that ensures direct access to sources, speeds up sales, and provides a unique and profitable shopping experience for all parties.',
  'for_customers_shoppers' => 'For Customers & Shoppers',
  'start_shopping' => 'Start Shopping',
  'customer_hero_desc' => 'Shop directly from sources at competitive prices with quality assurance and fast delivery.',
  'wholesale_prices' => 'Wholesale Prices',
  'fast_safe_delivery' => 'Fast & Safe Delivery to Your Door',
  'fair_return_policy' => 'Clear & Fair Return Policy',
  'download_app' => 'Download the App',
  'for_merchants_factories' => 'For Merchants, Factories & Suppliers',
  'start_selling' => 'Start Selling',
  'merchant_hero_desc' => 'Expand your business and connect with thousands of merchants and customers through an integrated logistics platform.',
  'smart_inventory_management' => 'Smart Inventory & Order Management from Your Phone',
  'guaranteed_secure_collection' => 'Guaranteed & Secure Financial Collection',
  'realtime_sales_reports' => 'Investment opportunities for real financial sovereignty',
  'register_as_seller_now' => 'Register as a Seller Now',
  'for_delivery_captains' => 'For Delivery Captains',
  'start_as_captain' => 'Start as a Captain',
  'captain_hero_desc' => 'Join our logistics fleet and earn a rewarding additional income with full schedule flexibility.',
  'clear_fair_commission' => 'Clear & Fair Commission System',
  'easy_to_use_app' => 'Easy-to-use Captain App',
  '24_7_support' => '24/7 Technical Support',
  'register_as_nasia_captain' => 'Register as a Nasia Captain',
  'direct_source_access' => 'Direct Source Access',
  'direct_source_desc' => 'We shorten the path and connect you directly with factories and suppliers to ensure the lowest cost.',
  'smart_logistics_system' => 'Smart Logistics System',
  'smart_logistics_desc' => 'An organized shipping and delivery process that ensures your goods arrive safely and quickly.',
  'transparency_real_saving' => 'Transparency & Real Savings',
  'transparency_desc' => 'No hidden commissions or middlemen; every party knows their profit and benefits from special prices.',
  'start_with_nasia_selection_title' => 'Start Your Successful Career with Nasia',
  'start_with_nasia_selection_desc' => 'Choose the role that suits you, and start a journey of growth and financial independence.',
  'app_features_label' => 'More Than Just an App',
  'smart_ecosystem_title' => 'A Tech Ecosystem That Meets Your Ambitions',
  'smart_ecosystem_desc' => 'We save you time and effort - in Nasia you can manage your trade easily and securely.',
  'eco_supplier_factory' => 'Supplier / Factory',
  'eco_supplier_desc' => 'Product and sales channel management reaching thousands of retailers',
  'eco_merchant' => 'Merchant',
  'eco_merchant_desc' => 'Wholesale purchasing, inventory, and sales management',
  'eco_customer' => 'Shopper / Customer',
  'eco_customer_desc' => 'Smart saving and delivery to your home with the best quality',
  'eco_captain' => 'Delivery Captain',
  'eco_captain_desc' => 'Integrated logistics for accurate delivery and instant collection',
  'how_nasia_works_label' => 'How Nasia Works?',
  'nasia_ecosystem_title' => 'A System Connecting Four Parties in One Cycle',
  'nasia_ecosystem_sub' => 'From the factory to the customer`s door - every step is organized, safe, and profitable.',
  'eco_step_1_title' => 'Factory / Supplier',
  'eco_step_1_desc' => 'Lists their products at wholesale directly on the platform',
  'eco_step_2_title' => 'Merchant',
  'eco_step_2_desc' => 'Orders wholesale at competitive prices without middlemen',
  'eco_step_3_title' => 'Customer',
  'eco_step_3_desc' => 'Shops at lower prices with a smooth and safe experience',
  'eco_step_4_title' => 'Delivery Captain',
  'eco_step_4_desc' => 'Delivers orders quickly and earns fair commission',
  'all_parties_win_label' => 'Everyone Wins — Platform Guarantees — Everyone Grows',
  'merchant' => 'Merchant',
  'supplier' => 'Supplier',
  'captain' => 'Captain',
);